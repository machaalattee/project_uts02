   ...
   <body>
      ...
      <div class="header_section header_bg">
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a href="contact.php" class="logo"><img src="images/logo.jpg"></a>
                  ...
                  <div class="carousel-item">
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-md-5">
                              <h1 class="banner_taital">Sasya Stationery</h1> <br>
                              <p class="banner_text">Selamat datang di Toko Alat Tulis!
                           Kami adalah destinasi terbaik untuk memenuhi segala kebutuhan alat tulis Anda. </p>
                              <div class="contact_bt"><a href="contact.php">Shop Now</a></div>
                           </div>
                        </div>
